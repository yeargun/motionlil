// packages/motion-utils/dist/es/array.mjs
...
// packages/motion-utils/dist/es/clamp.mjs
var clamp = (min, max, v) => {
  if (v > max)
    return max;
  if (v < min)
...
// packages/motion-utils/dist/es/format-error-message.mjs
function formatErrorMessage(message, errorCode) {
  return errorCode ? `${message}. For more information and steps for solving, visit https://motion.dev/troubleshooting/${errorCode}` : message;
}

// packages/motion-utils/dist/es/errors.mjs
var warning = () => {
};
var invariant = () => {
};
...
// packages/motion-utils/dist/es/global-config.mjs
var MotionGlobalConfig = {};

// packages/motion-utils/dist/es/is-numerical-string.mjs
var isNumericalString = (v) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(v);

// packages/motion-utils/dist/es/is-object.mjs
var isObject = (value) => typeof value === "object" && value !== null;

// packages/motion-utils/dist/es/is-zero-value-string.mjs
var isZeroValueString = (v) => /^0[^.\s]+$/u.test(v);

// packages/motion-utils/dist/es/memo.mjs
// @__NO_SIDE_EFFECTS__
...
// packages/motion-utils/dist/es/noop.mjs
var noop = /* @__NO_SIDE_EFFECTS__ */ (any) => any;

// packages/motion-utils/dist/es/pipe.mjs
var pipe = (...transformers) => transformers.reduce((a, b) => (v) => b(a(v)));

// packages/motion-utils/dist/es/progress.mjs
var progress = /* @__NO_SIDE_EFFECTS__ */ (from, to, value) => {
  const range = to - from;
  return range ? (value - from) / range : 1;
};

// packages/motion-utils/dist/es/subscription-manager.mjs
...
// packages/motion-utils/dist/es/time-conversion.mjs
var secondsToMilliseconds = /* @__NO_SIDE_EFFECTS__ */ (seconds) => seconds * 1e3;
var millisecondsToSeconds = /* @__NO_SIDE_EFFECTS__ */ (milliseconds) => milliseconds / 1e3;

// packages/motion-utils/dist/es/velocity-per-second.mjs
var velocityPerSecond = /* @__NO_SIDE_EFFECTS__ */ (velocity, frameDuration) => frameDuration ? velocity * (1e3 / frameDuration) : 0;

// packages/motion-utils/dist/es/warn-once.mjs
...
// packages/motion-utils/dist/es/wrap.mjs
var wrap = (min, max, v) => {
  const rangeSize = max - min;
  return ((v - min) % rangeSize + rangeSize) % rangeSize + min;
};

// packages/motion-utils/dist/es/easing/cubic-bezier.mjs
...
// packages/motion-utils/dist/es/easing/modifiers/mirror.mjs
var mirrorEasing = /* @__NO_SIDE_EFFECTS__ */ (easing) => (p) => p <= 0.5 ? easing(2 * p) / 2 : (2 - easing(2 * (1 - p))) / 2;

// packages/motion-utils/dist/es/easing/modifiers/reverse.mjs
var reverseEasing = /* @__NO_SIDE_EFFECTS__ */ (easing) => (p) => 1 - easing(1 - p);

// packages/motion-utils/dist/es/easing/back.mjs
var backOut = /* @__PURE__ */ cubicBezier(0.33, 1.53, 0.69, 0.99);
var backIn = /* @__PURE__ */ reverseEasing(backOut);
var backInOut = /* @__PURE__ */ mirrorEasing(backIn);

// packages/motion-utils/dist/es/easing/anticipate.mjs
var anticipate = (p) => p >= 1 ? 1 : (p *= 2) < 1 ? 0.5 * backIn(p) : 0.5 * (2 - Math.pow(2, -10 * (p - 1)));

// packages/motion-utils/dist/es/easing/circ.mjs
var circIn = (p) => 1 - Math.sin(Math.acos(p));
var circOut = reverseEasing(circIn);
var circInOut = mirrorEasing(circIn);

// packages/motion-utils/dist/es/easing/ease.mjs
var easeIn = /* @__PURE__ */ cubicBezier(0.42, 0, 1, 1);
var easeOut = /* @__PURE__ */ cubicBezier(0, 0, 0.58, 1);
var easeInOut = /* @__PURE__ */ cubicBezier(0.42, 0, 0.58, 1);

// packages/motion-utils/dist/es/easing/steps.mjs
// @__NO_SIDE_EFFECTS__
...
// packages/motion-utils/dist/es/easing/utils/is-easing-array.mjs
var isEasingArray = /* @__NO_SIDE_EFFECTS__ */ (ease2) => {
  return Array.isArray(ease2) && typeof ease2[0] !== "number";
};

// packages/motion-utils/dist/es/easing/utils/get-easing-for-segment.mjs
// @__NO_SIDE_EFFECTS__
function getEasingForSegment(easing, i) {
  return isEasingArray(easing) ? easing[wrap(0, easing.length, i)] : easing;
}

// packages/motion-utils/dist/es/easing/utils/is-bezier-definition.mjs
var isBezierDefinition = /* @__NO_SIDE_EFFECTS__ */ (easing) => Array.isArray(easing) && typeof easing[0] === "number";

// packages/motion-utils/dist/es/easing/utils/map.mjs
var easingLookup = {
  linear: noop,
  easeIn,
  easeInOut,
...
// packages/motion-dom/dist/es/frameloop/order.mjs
var stepsOrder = [
  "setup",
  // Compute
  "read",
...
// packages/motion-dom/dist/es/frameloop/render-step.mjs
...
// packages/motion-dom/dist/es/frameloop/batcher.mjs
var maxElapsed = 40;
...
// packages/motion-dom/dist/es/frameloop/frame.mjs
var { schedule: frame, cancel: cancelFrame, state: frameData, steps: frameSteps } = /* @__PURE__ */ createRenderBatcher(typeof requestAnimationFrame !== "undefined" ? requestAnimationFrame : noop, true);

// packages/motion-dom/dist/es/frameloop/sync-time.mjs
var now;
function clearTime() {
  now = void 0;
}
...
// packages/motion-dom/dist/es/animation/utils/is-css-variable.mjs
...
// packages/motion-dom/dist/es/value/types/numbers/index.mjs
var number = {
...
// packages/motion-dom/dist/es/value/types/utils/sanitize.mjs
var sanitize = (v) => Math.round(v * 1e5) / 1e5;

// packages/motion-dom/dist/es/value/types/utils/float-regex.mjs
var floatRegex = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;

// packages/motion-dom/dist/es/value/types/utils/is-nullish.mjs
function isNullish(v) {
  return v == null;
}

// packages/motion-dom/dist/es/value/types/utils/single-color-regex.mjs
var singleColorRegex = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu;

// packages/motion-dom/dist/es/value/types/color/utils.mjs
...
// packages/motion-dom/dist/es/value/types/color/rgba.mjs
...
// packages/motion-dom/dist/es/value/types/color/hex.mjs
function parseHex(v) {
  let r = "";
  let g = "";
  let b = "";
...
// packages/motion-dom/dist/es/value/types/numbers/units.mjs
...
// packages/motion-dom/dist/es/value/types/color/hsla.mjs
var hsla = {
...
// packages/motion-dom/dist/es/value/types/color/index.mjs
var color = {
...
// packages/motion-dom/dist/es/value/types/utils/color-regex.mjs
var colorRegex = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;

// packages/motion-dom/dist/es/value/types/complex/index.mjs
function test(v) {
...
// packages/motion-dom/dist/es/value/types/color/hsla-to-rgba.mjs
...
// packages/motion-dom/dist/es/utils/mix/immediate.mjs
function mixImmediate(a, b) {
  return (p) => p > 0 ? b : a;
}

// packages/motion-dom/dist/es/utils/mix/number.mjs
var mixNumber = (from, to, progress2) => {
  return from + (to - from) * progress2;
};

// packages/motion-dom/dist/es/utils/mix/color.mjs
...
// packages/motion-dom/dist/es/utils/mix/visibility.mjs
...
// packages/motion-dom/dist/es/utils/mix/complex.mjs
...
// packages/motion-dom/dist/es/utils/mix/index.mjs
...
// packages/motion-dom/dist/es/animation/drivers/frame.mjs
...
// packages/motion-dom/dist/es/animation/waapi/utils/linear.mjs
...
// packages/motion-dom/dist/es/animation/generators/utils/calc-duration.mjs
...
// packages/motion-dom/dist/es/animation/generators/utils/create-generator-easing.mjs
...
// packages/motion-dom/dist/es/animation/generators/spring.mjs
var springDefaults = {
...
// packages/motion-dom/dist/es/animation/generators/utils/velocity.mjs
...
// packages/motion-dom/dist/es/animation/generators/inertia.mjs
...
// packages/motion-dom/dist/es/utils/interpolate.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/offsets/fill.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/offsets/default.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/offsets/time.mjs
function convertOffsetToTimes(offset, duration) {
  return offset.map((o) => o * duration);
}

// packages/motion-dom/dist/es/animation/generators/keyframes.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/get-final.mjs
...
// packages/motion-dom/dist/es/animation/utils/replace-transition-type.mjs
...
// packages/motion-dom/dist/es/animation/utils/WithPromise.mjs
...
// packages/motion-dom/dist/es/animation/JSAnimation.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/utils/fill-wildcards.mjs
...
// packages/motion-dom/dist/es/render/dom/parse-transform.mjs
...
// packages/motion-dom/dist/es/render/utils/keys-transform.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/utils/unit-conversion.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/KeyframesResolver.mjs
...
// packages/motion-dom/dist/es/render/dom/is-css-var.mjs
var isCSSVar = (name) => name.startsWith("--");

// packages/motion-dom/dist/es/render/dom/style-set.mjs
function setStyle(element, name, value) {
  isCSSVar(name) ? element.style.setProperty(name, value) : element.style[name] = value;
}

// packages/motion-dom/dist/es/utils/supports/flags.mjs
var supportsFlags = {};

// packages/motion-dom/dist/es/utils/supports/memo.mjs
function memoSupports(callback, supportsFlag) {
  const memoized = memo(callback);
  return () => supportsFlags[supportsFlag] ?? memoized();
}

// packages/motion-dom/dist/es/utils/supports/scroll-timeline.mjs
...
// packages/motion-dom/dist/es/utils/supports/linear-easing.mjs
...
// packages/motion-dom/dist/es/animation/waapi/easing/cubic-bezier.mjs
var cubicBezierAsString = ([a, b, c, d]) => `cubic-bezier(${a}, ${b}, ${c}, ${d})`;

// packages/motion-dom/dist/es/animation/waapi/easing/supported.mjs
...
// packages/motion-dom/dist/es/animation/waapi/easing/map-easing.mjs
...
// packages/motion-dom/dist/es/animation/waapi/start-waapi-animation.mjs
...
// packages/motion-dom/dist/es/animation/generators/utils/is-generator.mjs
function isGenerator(type) {
  return typeof type === "function" && "applyToOptions" in type;
}

// packages/motion-dom/dist/es/animation/waapi/utils/apply-generator.mjs
...
// packages/motion-dom/dist/es/animation/NativeAnimation.mjs
...
// packages/motion-dom/dist/es/animation/waapi/utils/unsupported-easing.mjs
...
// packages/motion-dom/dist/es/animation/NativeAnimationExtended.mjs
var sampleDelta = 10;
...
// packages/motion-dom/dist/es/animation/utils/is-animatable.mjs
...
// packages/motion-dom/dist/es/animation/utils/can-animate.mjs
...
// packages/motion-dom/dist/es/animation/utils/make-animation-instant.mjs
function makeAnimationInstant(options) {
  options.duration = 0;
  options.type = "keyframes";
}

// packages/motion-dom/dist/es/animation/waapi/utils/accelerated-values.mjs
...
// packages/motion-dom/dist/es/animation/waapi/utils/is-browser-color.mjs
...
// packages/motion-dom/dist/es/animation/waapi/supports/waapi.mjs
...
// packages/motion-dom/dist/es/animation/AsyncMotionValueAnimation.mjs
...
// packages/motion-dom/dist/es/animation/GroupAnimation.mjs
...
// packages/motion-dom/dist/es/animation/GroupAnimationWithThen.mjs
...
// packages/motion-dom/dist/es/animation/NativeAnimationWrapper.mjs
...
// packages/motion-dom/dist/es/animation/utils/active-animations.mjs
...
// packages/motion-dom/dist/es/animation/utils/calc-child-stagger.mjs
...
// packages/motion-dom/dist/es/value/index.mjs
...
// packages/motion-dom/dist/es/animation/utils/resolve-transition.mjs
...
// packages/motion-dom/dist/es/animation/utils/get-value-transition.mjs
...
// packages/motion-dom/dist/es/animation/utils/default-transitions.mjs
...
// packages/motion-dom/dist/es/animation/utils/is-transition-defined.mjs
...
// packages/motion-dom/dist/es/animation/interfaces/motion-value.mjs
...
// packages/motion-dom/dist/es/animation/utils/arc.mjs
...
// packages/motion-dom/dist/es/animation/utils/css-variables-conversion.mjs
...
// packages/motion-dom/dist/es/render/utils/resolve-variants.mjs
...
// packages/motion-dom/dist/es/render/utils/resolve-dynamic-variants.mjs
function resolveVariant(visualElement, definition, custom) {
  const props = visualElement.getProps();
  return resolveVariantFromProps(props, definition, custom !== void 0 ? custom : props.custom, visualElement);
}

// packages/motion-dom/dist/es/render/utils/keys-position.mjs
...
// packages/motion-dom/dist/es/render/utils/is-keyframes-target.mjs
var isKeyframesTarget = (v) => {
  return Array.isArray(v);
};

// packages/motion-dom/dist/es/render/utils/setters.mjs
...
// packages/motion-dom/dist/es/value/utils/is-motion-value.mjs
var isMotionValue = (value) => Boolean(value && value.getVelocity);

// packages/motion-dom/dist/es/value/will-change/is.mjs
function isWillChangeMotionValue(value) {
  return Boolean(isMotionValue(value) && value.add);
}

// packages/motion-dom/dist/es/value/will-change/add-will-change.mjs
...
// packages/motion-dom/dist/es/render/dom/utils/camel-to-dash.mjs
function camelToDash(str) {
  return str.replace(/([A-Z])/g, (match) => `-${match.toLowerCase()}`);
}

// packages/motion-dom/dist/es/animation/optimized-appear/data-id.mjs
var optimizedAppearDataId = "framerAppearId";
var optimizedAppearDataAttribute = "data-" + camelToDash(optimizedAppearDataId);

// packages/motion-dom/dist/es/animation/optimized-appear/get-appear-id.mjs
function getOptimisedAppearId(visualElement) {
  return visualElement.props[optimizedAppearDataAttribute];
}

// packages/motion-dom/dist/es/animation/interfaces/visual-element-target.mjs
...
// packages/motion-dom/dist/es/animation/interfaces/visual-element-variant.mjs
...
// packages/motion-dom/dist/es/animation/interfaces/visual-element.mjs
...
// packages/motion-dom/dist/es/value/types/auto.mjs
var auto = {
  test: (v) => v === "auto",
  parse: (v) => v
};

// packages/motion-dom/dist/es/value/types/test.mjs
var testValueType = (v) => (type) => type.test(v);

// packages/motion-dom/dist/es/value/types/dimensions.mjs
var dimensionValueTypes = [number, px, percent, degrees, vw, vh, auto];
var findDimensionValueType = (v) => dimensionValueTypes.find(testValueType(v));

// packages/motion-dom/dist/es/animation/keyframes/utils/is-none.mjs
...
// packages/motion-dom/dist/es/value/types/complex/filter.mjs
...
// packages/motion-dom/dist/es/value/types/complex/mask.mjs
var mask = {
  ...complex,
  getAnimatableNone: (v) => {
...
// packages/motion-dom/dist/es/value/types/int.mjs
var int = {
  ...number,
  transform: Math.round
};

// packages/motion-dom/dist/es/value/types/maps/transform.mjs
...
// packages/motion-dom/dist/es/value/types/maps/number.mjs
...
// packages/motion-dom/dist/es/value/types/maps/defaults.mjs
...
// packages/motion-dom/dist/es/value/types/utils/animatable-none.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/utils/make-none-animatable.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/DOMKeyframesResolver.mjs
...
// packages/motion-dom/dist/es/utils/border-radius.mjs
...
// packages/motion-dom/dist/es/animation/waapi/utils/px-values.mjs
...
// packages/motion-dom/dist/es/animation/keyframes/utils/apply-px-defaults.mjs
...
// packages/motion-dom/dist/es/animation/waapi/easing/is-supported.mjs
function isWaapiSupportedEasing(easing) {
  return Boolean(typeof easing === "function" && supportsLinearEasing() || !easing || typeof easing === "string" && (easing in supportedWaapiEasing || supportsLinearEasing()) || isBezierDefinition(easing) || Array.isArray(easing) && easing.every(isWaapiSupportedEasing));
}

// packages/motion-dom/dist/es/animation/waapi/supports/partial-keyframes.mjs
...
// packages/motion-dom/dist/es/utils/resolve-elements.mjs
...
// packages/motion-dom/dist/es/effects/utils/create-dom-effect.mjs
...
// packages/motion-dom/dist/es/value/types/utils/get-as-type.mjs
var getValueAsType = (value, type) => {
  return type && typeof value === "number" ? type.transform(value) : value;
};

// packages/motion-dom/dist/es/effects/MotionValueState.mjs
...
// packages/motion-dom/dist/es/effects/utils/create-effect.mjs
...
// packages/motion-dom/dist/es/effects/attr/index.mjs
...
// packages/motion-dom/dist/es/effects/prop/index.mjs
...
// packages/motion-dom/dist/es/utils/is-html-element.mjs
function isHTMLElement(element) {
  return isObject(element) && "offsetHeight" in element && !("ownerSVGElement" in element);
}

// packages/motion-dom/dist/es/effects/style/transform.mjs
var translateAlias = {
  x: "translateX",
  y: "translateY",
  z: "translateZ",
...
// packages/motion-dom/dist/es/effects/style/index.mjs
...
// packages/motion-dom/dist/es/effects/svg/index.mjs
...
// packages/motion-dom/dist/es/frameloop/microtask.mjs
var { schedule: microtask, cancel: cancelMicrotask } = /* @__PURE__ */ createRenderBatcher(queueMicrotask, false);

// packages/motion-dom/dist/es/gestures/drag/state/is-active.mjs
var isDragging = {
  x: false,
  y: false
};
...
// packages/motion-dom/dist/es/gestures/drag/state/set-active.mjs
...
// packages/motion-dom/dist/es/gestures/utils/setup.mjs
...
// packages/motion-dom/dist/es/gestures/hover.mjs
...
// packages/motion-dom/dist/es/gestures/utils/is-node-or-child.mjs
...
// packages/motion-dom/dist/es/gestures/utils/is-primary-pointer.mjs
...
// packages/motion-dom/dist/es/gestures/press/utils/is-keyboard-accessible.mjs
...
// packages/motion-dom/dist/es/gestures/press/utils/state.mjs
var isPressing = /* @__PURE__ */ new WeakSet();

// packages/motion-dom/dist/es/gestures/press/utils/keyboard.mjs
...
// packages/motion-dom/dist/es/gestures/press/index.mjs
...
// packages/motion-dom/dist/es/render/dom/style-computed.mjs
...
// packages/motion-dom/dist/es/utils/is-svg-element.mjs
function isSVGElement(element) {
  return isObject(element) && "ownerSVGElement" in element;
}

// packages/motion-dom/dist/es/resize/handle-element.mjs
...
// packages/motion-dom/dist/es/resize/handle-window.mjs
...
// packages/motion-dom/dist/es/resize/index.mjs
function resize(a, b) {
  return typeof a === "function" ? resizeWindow(a) : resizeElement(a, b);
}

// packages/motion-dom/dist/es/scroll/observe.mjs
...
// packages/motion-dom/dist/es/stats/buffer.mjs
var statsBuffer = {
  value: null,
  addProjectionMetrics: null
};

// packages/motion-dom/dist/es/stats/index.mjs
...
// packages/motion-dom/dist/es/utils/is-svg-svg-element.mjs
function isSVGSVGElement(element) {
  return isSVGElement(element) && element.tagName === "svg";
}

// packages/motion-dom/dist/es/utils/stagger.mjs
...
// packages/motion-dom/dist/es/utils/transform.mjs
...
// packages/motion-dom/dist/es/value/follow-value.mjs
...
// packages/motion-dom/dist/es/value/subscribe-value.mjs
...
// packages/motion-dom/dist/es/value/transform-value.mjs
...
// packages/motion-dom/dist/es/value/map-value.mjs
function mapValue(inputValue, inputRange, outputRange, options) {
  const map = transform(inputRange, outputRange, options);
  return transformValue(() => map(inputValue.get()));
}

// packages/motion-dom/dist/es/value/spring-value.mjs
...
// packages/motion-dom/dist/es/value/types/utils/find.mjs
var valueTypes = [...dimensionValueTypes, color, complex];
var findValueType = (v) => valueTypes.find(testValueType(v));

// packages/motion-dom/dist/es/view/utils/assign-names.mjs
var nameCount = 0;
...
// packages/motion-dom/dist/es/view/utils/choose-layer-type.mjs
...
// packages/motion-dom/dist/es/view/utils/css.mjs
var pendingRules = {};
var style = null;
var css = {
  set: (selector, values) => {
...
// packages/motion-dom/dist/es/view/utils/get-layer-info.mjs
...
// packages/motion-dom/dist/es/view/utils/get-view-animations.mjs
...
// packages/motion-dom/dist/es/view/utils/has-target.mjs
function hasTarget(target, targets) {
  return targets.has(target) && Object.keys(targets.get(target)).length > 0;
}

// packages/motion-dom/dist/es/view/start.mjs
...
// packages/motion-dom/dist/es/view/queue.mjs
var builders = [];
var current = null;
function next() {
  current = null;
...
// packages/motion-dom/dist/es/view/index.mjs
...
// packages/motion-dom/dist/es/projection/geometry/models.mjs
var createAxisDelta = () => ({
  translate: 0,
  scale: 1,
  origin: 0,
...
// packages/motion-dom/dist/es/render/store.mjs
var visualElementStore = /* @__PURE__ */ new WeakMap();

// packages/motion-dom/dist/es/render/utils/is-animation-controls.mjs
function isAnimationControls(v) {
  return v !== null && typeof v === "object" && typeof v.start === "function";
}

// packages/motion-dom/dist/es/render/utils/is-variant-label.mjs
function isVariantLabel(v) {
  return typeof v === "string" || Array.isArray(v);
}

// packages/motion-dom/dist/es/render/utils/variant-props.mjs
...
// packages/motion-dom/dist/es/render/utils/is-controlling-variants.mjs
...
// packages/motion-dom/dist/es/render/utils/motion-values.mjs
...
// packages/motion-dom/dist/es/render/utils/reduced-motion/state.mjs
var prefersReducedMotion = { current: null };
var hasReducedMotionListener = { current: false };

// packages/motion-dom/dist/es/render/utils/reduced-motion/index.mjs
...
// packages/motion-dom/dist/es/render/VisualElement.mjs
...
// packages/motion-dom/dist/es/render/dom/DOMVisualElement.mjs
...
// packages/motion-dom/dist/es/render/Feature.mjs
var Feature = class {
  constructor(node) {
...
// packages/motion-dom/dist/es/projection/geometry/conversion.mjs
...
// packages/motion-dom/dist/es/projection/utils/has-transform.mjs
...
// packages/motion-dom/dist/es/projection/geometry/delta-apply.mjs
...
// packages/motion-dom/dist/es/projection/utils/measure.mjs
...
// packages/motion-dom/dist/es/render/html/utils/build-transform.mjs
var translateAlias2 = {
  x: "translateX",
  y: "translateY",
  z: "translateZ",
...
// packages/motion-dom/dist/es/render/html/utils/build-styles.mjs
...
// packages/motion-dom/dist/es/render/html/utils/render.mjs
...
// packages/motion-dom/dist/es/projection/styles/scale-border-radius.mjs
...
// packages/motion-dom/dist/es/projection/styles/scale-box-shadow.mjs
...
// packages/motion-dom/dist/es/projection/styles/scale-correction.mjs
var scaleCorrectors = {
  borderRadius: {
    ...correctBorderRadius,
...
// packages/motion-dom/dist/es/render/utils/is-forced-motion-value.mjs
function isForcedMotionValue(key, { layout, layoutId }) {
  return transformProps.has(key) || key.startsWith("origin") || (layout || layoutId !== void 0) && (!!scaleCorrectors[key] || key === "opacity");
}

// packages/motion-dom/dist/es/render/html/utils/scrape-motion-values.mjs
...
// packages/motion-dom/dist/es/render/html/HTMLVisualElement.mjs
...
// packages/motion-dom/dist/es/render/object/ObjectVisualElement.mjs
...
// packages/motion-dom/dist/es/render/svg/utils/path.mjs
var dashKeys = {
...
// packages/motion-dom/dist/es/render/svg/utils/build-attrs.mjs
...
// packages/motion-dom/dist/es/render/svg/utils/camel-case-attrs.mjs
...
// packages/motion-dom/dist/es/render/svg/utils/is-svg-tag.mjs
var isSVGTag = (tag) => typeof tag === "string" && tag.toLowerCase() === "svg";

// packages/motion-dom/dist/es/render/svg/utils/render.mjs
...
// packages/motion-dom/dist/es/render/svg/utils/scrape-motion-values.mjs
...
// packages/motion-dom/dist/es/render/svg/SVGVisualElement.mjs
...
// packages/motion-dom/dist/es/render/utils/get-variant-context.mjs
...
// packages/motion-dom/dist/es/render/utils/shallow-compare.mjs
...
// packages/motion-dom/dist/es/render/utils/animation-state.mjs
...
// packages/motion-dom/dist/es/projection/geometry/copy.mjs
...
// packages/motion-dom/dist/es/projection/geometry/delta-calc.mjs
...
// packages/motion-dom/dist/es/projection/geometry/delta-remove.mjs
...
// packages/motion-dom/dist/es/projection/geometry/utils.mjs
...
// packages/motion-dom/dist/es/projection/utils/each-axis.mjs
function eachAxis(callback) {
  return [callback("x"), callback("y")];
}

// packages/motion-dom/dist/es/projection/styles/transform.mjs
...
// packages/motion-dom/dist/es/projection/animation/mix-values.mjs
...
// packages/motion-dom/dist/es/animation/animate/single-value.mjs
...
// packages/motion-dom/dist/es/events/add-dom-event.mjs
function addDomEvent(target, eventName, handler, options = { passive: true }) {
  target.addEventListener(eventName, handler, options);
  return () => target.removeEventListener(eventName, handler, options);
}

// packages/motion-dom/dist/es/projection/utils/compare-by-depth.mjs
var compareByDepth = (a, b) => a.depth - b.depth;

// packages/motion-dom/dist/es/projection/utils/flat-tree.mjs
var FlatTree = class {
  constructor() {
    this.children = [];
    this.isDirty = false;
...
// packages/motion-dom/dist/es/utils/delay.mjs
...
// packages/motion-dom/dist/es/value/utils/resolve-motion-value.mjs
function resolveMotionValue(value) {
  return isMotionValue(value) ? value.get() : value;
}

// packages/motion-dom/dist/es/projection/shared/stack.mjs
var NodeStack = class {
  constructor() {
    this.members = [];
  }
...
// packages/motion-dom/dist/es/projection/node/state.mjs
...
// packages/motion-dom/dist/es/projection/node/create-projection-node.mjs
var metrics = {
  nodes: 0,
...
// packages/motion-dom/dist/es/projection/node/DocumentProjectionNode.mjs
...
// packages/motion-dom/dist/es/projection/node/group.mjs
...
// packages/motion-dom/dist/es/projection/node/HTMLProjectionNode.mjs
...
// packages/motion-dom/dist/es/layout/LayoutAnimationBuilder.mjs
...
// packages/motion-dom/dist/es/frameloop/index-legacy.mjs
var sync = frame;
...
// packages/framer-motion/dist/es/animation/utils/is-dom-keyframes.mjs
function isDOMKeyframes(keyframes2) {
  return typeof keyframes2 === "object" && !Array.isArray(keyframes2);
}

// packages/framer-motion/dist/es/animation/animate/resolve-subjects.mjs
...
// packages/framer-motion/dist/es/animation/sequence/utils/calc-repeat-duration.mjs
function calculateRepeatDuration(duration, repeat, repeatDelay) {
  return duration * (repeat + 1) + repeatDelay * repeat;
}

// packages/framer-motion/dist/es/animation/sequence/utils/calc-time.mjs
...
// packages/framer-motion/dist/es/animation/sequence/utils/edit.mjs
...
// packages/framer-motion/dist/es/animation/sequence/utils/normalize-times.mjs
...
// packages/framer-motion/dist/es/animation/sequence/utils/sort.mjs
...
// packages/framer-motion/dist/es/animation/sequence/create.mjs
...
// packages/framer-motion/dist/es/animation/utils/create-visual-element.mjs
...
// packages/framer-motion/dist/es/animation/animate/subject.mjs
...
// packages/framer-motion/dist/es/animation/animate/sequence.mjs
...
// packages/framer-motion/dist/es/animation/animate/index.mjs
...
// packages/framer-motion/dist/es/animation/animators/waapi/animate-elements.mjs
...
// packages/framer-motion/dist/es/animation/animators/waapi/animate-style.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/utils/can-use-native-timeline.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/info.mjs
var maxElapsed2 = 50;
var createAxisInfo = () => ({
  current: 0,
  offset: [],
...
// packages/framer-motion/dist/es/render/dom/scroll/offsets/inset.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/offsets/edge.mjs
var namedEdges = {
  start: 0,
  center: 0.5,
  end: 1
...
// packages/framer-motion/dist/es/render/dom/scroll/offsets/offset.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/offsets/presets.mjs
var ScrollOffset = {
  Enter: [
    [0, 1],
    [1, 1]
...
// packages/framer-motion/dist/es/render/dom/scroll/offsets/index.mjs
var point = { x: 0, y: 0 };
...
// packages/framer-motion/dist/es/render/dom/scroll/on-scroll-handler.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/track.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/utils/offset-to-range.mjs
var presets = [
...
// packages/framer-motion/dist/es/render/dom/scroll/utils/get-timeline.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/attach-animation.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/utils/is-element-tracking.mjs
function isElementTracking(options) {
  return options && (options.target || options.offset);
}

// packages/framer-motion/dist/es/render/dom/scroll/attach-function.mjs
...
// packages/framer-motion/dist/es/render/dom/scroll/index.mjs
...
// packages/framer-motion/dist/es/render/dom/viewport/index.mjs
var thresholds = {
  some: 0,
  all: 1
};
...
// packages/framer-motion/dist/es/utils/distance.mjs
