import { AnyResolvedKeyframe, UnresolvedValueKeyframe, AnimationOptions, MotionValue, Transition, ElementOrSelector, DOMKeyframesDefinition, AnimationPlaybackOptions, AnimationPlaybackControlsWithThen, ValueAnimationTransition, AnimationScope, AnimationPlaybackControls } from './motion-dom.js';
export * from './motion-dom.js';
export { DelayedFunction, delayInSeconds as delay } from './motion-dom.js';
import { Easing, EasingFunction, Point } from './motion-utils.js';
